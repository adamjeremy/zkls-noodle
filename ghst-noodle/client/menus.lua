...
RegisterNetEvent('ghst-noodle'..Config.Job..':client:OpenFood', function()
    local text = ''
    local FoodMenu = {}
  ...
  for k, v in pairs(Config.Food) do
    ...
    item.icon = v.Item
    item.params = {
        event = 'ghst-noodle'..Config.Job..':client:MakeItem',
        args = {
            item = v.Item,
            itemID = k,
            required = v.Required,
...
RegisterNetEvent('ghst-noodle'..Config.Job..':client:OpenDrinks', function()
    local text = ''
    local DrinksMenu = {}
...
RegisterNetEvent('ghst-noodle'..Config.Job..':client:OpenAlcohol', function()
    local text = ''
    local AlcoholMenu = {}
...
RegisterNetEvent('ghst-noodle'..Config.Job..':client:OpenCoffee', function()
  local text = ''
  local CoffeeMenu = {}
