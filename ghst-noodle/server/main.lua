...
-- Get Item
QBCore.Functions.CreateCallback('ghst-noodle'..Config.Job..':server:GetItem',function(source, cb, item, required)
    local src = source
...
QBCore.Functions.CreateCallback('ghst-noodle'..Config.Job..':server:HasItems',function(source, cb, required)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local callback = false
    local idk = 0
